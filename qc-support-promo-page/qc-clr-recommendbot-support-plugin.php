...
add_action( 'wp_ajax_qcld_seo_recommend_support_function_ajax', 'qcld_seo_recommend_support_function_ajax' );

if( !function_exists('qcld_seo_recommend_support_function_ajax') ){

    function qcld_seo_recommend_support_function_ajax(){
